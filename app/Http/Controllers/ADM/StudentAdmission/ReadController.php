...
class ReadController extends Controller
{
    ...
    public function ViewParticipantList(Request $req)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('color_blind', function ($row) {
                return $row->color_blind;
            })
            ->addColumn('special_needs', function ($row) {
                return $row->special_needs;
            })
            ->make(true);
    }
